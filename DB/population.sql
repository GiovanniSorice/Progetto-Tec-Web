...
INSERT INTO serie VALUES('1', '../img/miniature/narcos_min.jpg', '../img/showsBackgrounds/narcos_back.jpg', 'Narcos', 'Netflix', 'La serie racconta la storia vera della dilagante diffusione della cocaina tra Stati Uniti ed Europa negli anni ottanta. Le prime due stagioni sono incentrate sulla lotta delle autorit&agrave; colombiane e della DEA contro il narcotrafficante Pablo Escobar e il cartello di Medellín, mentre la terza stagione &egrave; incentrata sulla lotta al cartello di Cali, guidato dai fratelli Gilberto e Miguel Rodríguez Orejuela.', 'Chris Brancato', '1', '0', '0', '0', '0' );
INSERT INTO serie VALUES('2', '../img/miniature/daredevil_min.jpg', '', 'Daredevil', 'Netflix', 'Matt Murdock, dopo aver perso la vista da bambino a causa di un incidente radioattivo, sviluppa dei sensi sovrumani e li utilizza per combattere il crimine per le strade della sua citt&agrave; nei panni del supereroe Daredevil. Nella prima stagione Matt affronta il potente signore del crimine Wilson Fisk, alias Kingpin, impegnato nella sua opera di riqualificazione del quartiere in combutta con vari esponenti della malavita della citt&agrave;.', 'Drew Goddard', '0', '0', '0', '0', '0' );
INSERT INTO serie VALUES('3', '', '', 'The Walking Dead', 'AMC', 'Rick Graims &egrave; un vice sceriffo vittima di un incidente durante uno scontro a fuoco con dei fuorilegge: colpito alla schiena, va in coma, lasciando tra le lacrime la moglie Lori e il figlio Carl. Il risveglio, poco tempo dopo, &egrave; traumatico. Rick non ci metter&agrave; molto a capire la situazione: il virus che sembrava essere controllato prima del suo incidente, ha preso piede.', 'Frank Darabont', '0', '0', '0', '0', '0' );
...
INSERT INTO serie VALUES('6', '../img/miniature/breakingBad_min.jpg', '', 'Breaking Bad', 'AMC', 'Quando a Walter viene diagnosticato un cancro ai polmoni, i suoi problemi sembrano precipitare. Tuttavia, in seguito al casuale incontro con Jesse Pinkman, un suo ex studente diventato uno spacciatore di poco conto, Walter decide di cucinare i cristalli di metanfetamina. Il prodotto di Walter si rivela per&ograve; di qualit&agrave; nettamente superiore rispetto alla concorrenza, con una purezza del 99,1%, derivante dalle sue conoscenze chimiche. Decide quindi di sfruttare le sue capacit&agrave; per prendere il controllo del mercato della droga.', 'Vince Gilligan', '1', '0', '0', '0', '0' );
INSERT INTO serie VALUES('7', '../img/miniature/mrRobot_min.jpg', '', 'Mr Robot', 'USA Network', 'Elliot viene avvicinato da Mr. Robot, un misterioso anarchico-insurrezionalista, che intende introdurlo in un gruppo di hacktivisti conosciuti con il nome di fsociety. Il manifesto di fsociety &egrave; liberare la popolazione dai debiti con le banche e smascherare i potenti che stanno distruggendo il mondo.', 'Sam Esmail', '0', '0', '0', '0', '0' );
INSERT INTO serie VALUES('8', '', '', 'Sherlock', 'BBC', 'La serie &egrave; un libero adattamento dei romanzi e dei racconti di Sir Arthur Conan Doyle e vede come protagonista il detective Sherlock Holmes, affiancato dal suo amico e assistente, il dottor John Watson. Le avventure dei due si svolgono per&ograve; nella Londra odierna, e non in quella presentata da Doyle. Watson &egrave; un reduce della guerra in Afghanistan e deve ancora ritrovare il suo posto nella societ&agrave;. Quando un amico gli suggerisce di trovarsi un coinquilino con cui dividere le spese di un appartamento, si ritrova a vivere con Sherlock Holmes, che col passare degli anni diventer&agrave; suo compagno di vita.', 'Steven Moffat', '0', '0', '0', '0', '0' );
INSERT INTO serie VALUES('9', '../img/miniature/casaDePapel_min.jpg', '', 'La Casa de Papel', 'Netflix', 'Otto ladri si barricano nell\'edificio della Zecca spagnola con alcuni ostaggi, mentre una mente criminale manipola la polizia per mettere in atto il suo piano.', 'Alex Pina', '0', '0', '0', '0', '0' );
INSERT INTO serie VALUES('10', '../img/miniature/heathers_min.jpg', '', 'Heathers', 'Paramount Network', 'La serie &egrave; stata pensata per essere un\'antologia, con ogni stagione che si svolge in un contesto completamente diverso.', 'Jason Micallef', '0', '0', '0', '0', '0' );
INSERT INTO serie VALUES('11', '../img/miniature/blackMirror_min.jpg', '', 'Black Mirror', 'Netflix', 'Questa serie di fantascienza esplora un futuro prossimo, tecnologico e inquietante, nel quale le invenzioni pi&ugrave; innovative si scontrano con i pi&ugrave; oscuri istinti umani.', 'Charlie Brooker', '0', '0', '0', '0', '0' );
INSERT INTO serie VALUES('12', '../img/miniature/elite_min.jpg', '', 'Elite', 'Netflix', 'Quando tre adolescenti figli di operai sono ammessi in una delle scuole private pi&ugrave; esclusive della Spagna, lo scontro con i ricchi coetanei sfocia in un omicidio.', 'Carlos Montero', '0', '0', '0', '0', '0' );
INSERT INTO serie VALUES('13', '../img/miniature/thePurge_min.jpg', '', 'The purge', 'Paramount Network', 'Ogni anno tutti i reati sono legali negli Stati Uniti per un periodo di 12 ore.', 'James DeMonaco', '0', '0', '0', '0', '0' );
INSERT INTO serie VALUES('14', '../img/miniature/limitless_min.jpg', '', 'Limitless', 'CBS', 'Brian Finch &egrave; un cittadino statunitense che, dopo aver assunto il farmaco sperimentale nootropo NZT, riesce a sfruttare le sue capacit&agrave; neurali molto al di sopra della media, acquisendo una memoria e una capacit&agrave; di comprensione e analisi sovrumane.', 'Craig Sweeny', '0', '0', '0', '0', '0' );
...
INSERT INTO commento VALUES('3', '2', '2', '', 'Alla fine muore');
...
INSERT INTO attore VALUES('5', '', 'Andrew', 'Lincoln', 'Andrew James Clutterbuck (Londra, 14 settembre 1973) &egrave; un attore britannico');
INSERT INTO attore VALUES('6', '', 'Norman', 'Reedus', 'Norman Mark Reedus (Hollywood, 6 gennaio 1969) &egrave; un attore e modello statunitense.');
INSERT INTO attore VALUES('7', '', 'Michiel', 'Huisman', 'Michiel Huisman &egrave; un attore, cantante e musicista olandese.');
INSERT INTO attore VALUES('8', '', 'Salvatore', 'Esposito', 'Salvatore Esposito (Napoli, 2 febbraio 1986) &egrave; un attore italiano. &egrave; noto principalmente per il ruolo di Gennaro "Genny" Savastano nella serie televisiva Gomorra.');
INSERT INTO attore VALUES('9', '', 'Bryan', 'Cranston', 'Bryan Lee Cranston (Los Angeles, 7 marzo 1956) &egrave; un attore, doppiatore, regista, sceneggiatore, produttore cinematografico e produttore televisivo statunitense.');
INSERT INTO attore VALUES('10', '', 'Aaron', 'Paul', 'Aaron Paul Sturtevant, noto semplicemente come Aaron Paul (Emmett, 26 agosto 1979) &egrave; un attore statunitense.');
...
INSERT INTO genere VALUES('9', 'Nuova uscita');
...
INSERT INTO serie_genere VALUES('13', '9');
INSERT INTO serie_genere VALUES('12', '9');
INSERT INTO serie_genere VALUES('10', '9');
