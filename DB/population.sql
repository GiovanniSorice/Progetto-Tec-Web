...
INSERT INTO serie VALUES('7', 'http://tvhunter.altervista.org/public/img/miniature/mrRobot_min.jpg', '', 'Mr Robot', 'USA Network', 'Elliot viene avvicinato da Mr. Robot, un misterioso anarchico-insurrezionalista, che intende introdurlo in un gruppo di hacktivisti conosciuti con il nome di fsociety. Il manifesto di fsociety &egrave; liberare la popolazione dai debiti con le banche e smascherare i potenti che stanno distruggendo il mondo.', 'Sam Esmail', '0', '0', '0', '0', '0' );
...
INSERT INTO serie VALUES('10', 'http://tvhunter.altervista.org/public/img/miniature/heathers_min.jpg', '', 'Heathers', 'Paramount Network', 'La serie &egrave; stata pensata per essere un\'antologia, con ogni stagione che si svolge in un contesto completamente diverso.', 'Jason Micallef', '0', '0', '0', '0', '0' );
INSERT INTO serie VALUES('11', 'http://tvhunter.altervista.org/public/img/miniature/blackMirror_min.jpg', '', 'Black Mirror', 'Netflix', 'Questa serie di fantascienza esplora un futuro prossimo, tecnologico e inquietante, nel quale le invenzioni pi&ugrave; innovative si scontrano con i pi&ugrave; oscuri istinti umani.', 'Charlie Brooker', '0', '0', '0', '0', '0' );
INSERT INTO serie VALUES('12', 'http://tvhunter.altervista.org/public/img/miniature/elite_min.jpg', '', 'Elite', 'Netflix', 'Quando tre adolescenti figli di operai sono ammessi in una delle scuole private pi&ugrave; esclusive della Spagna, lo scontro con i ricchi coetanei sfocia in un omicidio.', 'Carlos Montero', '0', '0', '0', '0', '0' );
...
INSERT INTO attore VALUES('11', 'http://tvhunter.altervista.org/public/img/miniature/attori/rami-malek_min.jpg', 'Rami', 'Malek', 'Rami Said Malek (Los Angeles, 12 maggio 1981) &egrave; un attore statunitense, noto principalmente per la sua interpretazione di Ahkmenrah nella saga di film Una notte al museo e di Elliot Alderson nella pluripremiata serie televisiva Mr. Robot, per la quale si aggiudica un Emmy per il miglior attore in una serie drammatica e riceve due nomination ai Golden Globe.');
