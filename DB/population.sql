...
INSERT INTO serie VALUES('6', '../img/miniature/breakingBad_min.jpg', '../img/showsBackgrounds/bb_back.jpg', 'Breaking Bad', 'AMC', 'Quando a Walter viene diagnosticato un cancro ai polmoni, i suoi problemi sembrano precipitare. Tuttavia, in seguito al casuale incontro con Jesse Pinkman, un suo ex studente diventato uno spacciatore di poco conto, Walter decide di cucinare i cristalli di metanfetamina. Il prodotto di Walter si rivela per&ograve; di qualit&agrave; nettamente superiore rispetto alla concorrenza, con una purezza del 99,1%, derivante dalle sue conoscenze chimiche. Decide quindi di sfruttare le sue capacit&agrave; per prendere il controllo del mercato della droga.', 'Vince Gilligan', '1', '0', '0', '0', '0' );
INSERT INTO serie VALUES('7', '../img/miniature/mrRobot_min.jpg', '../img/showsBackgrounds/mrrobot_back.jpg', 'Mr Robot', 'USA Network', 'Elliot viene avvicinato da Mr. Robot, un misterioso anarchico-insurrezionalista, che intende introdurlo in un gruppo di hacktivisti conosciuti con il nome di fsociety. Il manifesto di fsociety &egrave; liberare la popolazione dai debiti con le banche e smascherare i potenti che stanno distruggendo il mondo.', 'Sam Esmail', '0', '0', '0', '0', '0' );
INSERT INTO serie VALUES('8', '../img/miniature/sherlock_min.jpg', '../img/showsBackgrounds/sherlock_back.jpg', 'Sherlock', 'BBC', 'La serie &egrave; un libero adattamento dei romanzi e dei racconti di Sir Arthur Conan Doyle e vede come protagonista il detective Sherlock Holmes, affiancato dal suo amico e assistente, il dottor John Watson. Le avventure dei due si svolgono per&ograve; nella Londra odierna, e non in quella presentata da Doyle. Watson &egrave; un reduce della guerra in Afghanistan e deve ancora ritrovare il suo posto nella societ&agrave;. Quando un amico gli suggerisce di trovarsi un coinquilino con cui dividere le spese di un appartamento, si ritrova a vivere con Sherlock Holmes, che col passare degli anni diventer&agrave; suo compagno di vita.', 'Steven Moffat', '0', '0', '0', '0', '0' );
INSERT INTO serie VALUES('9', '../img/miniature/casaDePapel_min.jpg', '../img/showsBackgrounds/casaDePapel_back.jpg', 'La Casa de Papel', 'Netflix', 'Otto ladri si barricano nell\'edificio della Zecca spagnola con alcuni ostaggi, mentre una mente criminale manipola la polizia per mettere in atto il suo piano.', 'Alex Pina', '0', '0', '0', '0', '0' );
INSERT INTO serie VALUES('10', '../img/miniature/heathers_min.jpg', '../img/showsBackgrounds/heaters_back.jpg', 'Heathers', 'Paramount Network', 'La serie &egrave; stata pensata per essere un\'antologia, con ogni stagione che si svolge in un contesto completamente diverso.', 'Jason Micallef', '0', '0', '0', '0', '0' );
INSERT INTO serie VALUES('11', '../img/miniature/blackMirror_min.jpg', '../img/showsBackgrounds/blackmirror_back.jpg', 'Black Mirror', 'Netflix', 'Questa serie di fantascienza esplora un futuro prossimo, tecnologico e inquietante, nel quale le invenzioni pi&ugrave; innovative si scontrano con i pi&ugrave; oscuri istinti umani.', 'Charlie Brooker', '0', '0', '0', '0', '0' );
INSERT INTO serie VALUES('12', '../img/miniature/elite_min.jpg', '../img/showsBackgrounds/elite_back.jpg', 'Elite', 'Netflix', 'Quando tre adolescenti figli di operai sono ammessi in una delle scuole private pi&ugrave; esclusive della Spagna, lo scontro con i ricchi coetanei sfocia in un omicidio.', 'Carlos Montero', '0', '0', '0', '0', '0' );
INSERT INTO serie VALUES('13', '../img/miniature/thePurge_min.jpg', '../img/showsBackgrounds/thePurge_back.jpg', 'The purge', 'Paramount Network', 'Ogni anno tutti i reati sono legali negli Stati Uniti per un periodo di 12 ore.', 'James DeMonaco', '0', '0', '0', '0', '0' );
INSERT INTO serie VALUES('14', '../img/miniature/limitless_min.jpg', '../img/showsBackgrounds/limitless_back.jpg', 'Limitless', 'CBS', 'Brian Finch &egrave; un cittadino statunitense che, dopo aver assunto il farmaco sperimentale nootropo NZT, riesce a sfruttare le sue capacit&agrave; neurali molto al di sopra della media, acquisendo una memoria e una capacit&agrave; di comprensione e analisi sovrumane.', 'Craig Sweeny', '0', '0', '0', '0', '0' );
...
INSERT INTO attore VALUES('3', '../img/miniature/attori/charli-cox_min.jpg', 'Charli', 'Cox', 'Charlie Thomas Cox, meglio noto come Charlie Cox (Londra, 15 dicembre 1982), &egrave; un attore britannico, principalmente noto per aver interpretato Matt Murdock/Daredevil nella serie televisiva Daredevil');
